...
/*this is delet quer*/
mysqli_query($conn,"delete from user_info where user_id='$user_id'")or die("query is incorrect...");
}
            ...
            <div class="card ">
              ...
              <div class="card-body">
                ...
                <th>User Password</th>
                    ...
                    <tbody>
                      <?php 
                        $result=mysqli_query($conn,"select user_id, email, password from user_info")or die ("query 2 incorrect.......");
