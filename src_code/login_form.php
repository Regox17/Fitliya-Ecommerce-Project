								...
								<form onsubmit="return false" id="login" class="login100-form ">
                                    ...
                                    <div class="form-group">
                                       <label for="email">Email</label>
                                        <input class="input input-borders" type="email"  name="email" required placeholder="Enter your Email" id="email" required>
                                    </div>
                                    
                                    <div class="form-group">
                                       <label for="password">Password</label>
                                        <input class="input input-borders" type="password" name="password" required placeholder="Password" id="password" required >
                                    </div>
